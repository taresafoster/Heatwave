...
#get data in
data <-read.csv("mortalitywk2.csv",stringsAsFactors = FALSE,
...
ggsave(file="Figures/Taresapropmortalityfigure.pdf", p, width = 22, height = 22, units = "cm") #close the file before you save
